                ...
                <div className="container" style={{ backgroundColor: "#ffd200", borderRadius: "9px" }}>
                    <div className="container-inner text-dark border border-0 border-secondary d-flex flex-column justify-content-between flex-lg-row p-4 p-md-5" style={{ borderRadius: ".6rem" }}>
                        <div className="pb-2 pb-lg-1">
                            ...
                            <p className="mb-0">Navigate to our Contact form and send us an email. Our team will respond immediately.</p>
                        </div>
                        <div className="my-2"><Link className="btn btn-light fs-5 py-2 px-4" role="button" to="/contact">Contact us</Link></div>
                    </div>
                </div>
            </section>
                ...
                <div className="container py-4 py-lg-5">
                    <div className="row row-cols-2 row-cols-md-4 footer-content-wrapper">
                        ...
                        <div className="col-sm-4 col-md-3 text-lg-start d-flex flex-column content-inner">
                            <h3 className="fs-6 fw-bold">Explore</h3>
                            <ul className="list-unstyled">
                                <li><Link to="/concepts">Business Concepts</Link></li>
                                <li><Link to="/insights">Founders Insights</Link></li>
                        ...
                        <div className="col-sm-4 col-md-3 text-lg-start d-flex flex-column content-inner">
                            ...
                            <ul className="list-unstyled">
                                <li><Link to="/about-us">Our Business</Link></li>
                                <li><Link to="/collaborate-with-us">Collaborate with us</Link></li>
                            </ul>
                        </div>
                        <div className="col-sm-4 col-md-3 text-lg-start d-flex flex-column content-inner">
                    ...
                    <div className="text-muted d-flex justify-content-between align-items-center pt-3">
                        <p className="mb-0">Copyright © {new Date().getFullYear()} Foroden</p>
                        ...
                        <ul className="list-inline mb-0">
                            ...
                            <li className="list-inline-item"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-twitter-x" viewBox="0 0 16 16">
