...
export default function ConceptsCleanEnergy() {
                ...
                <div className="container py-5">
                    ...
                    <div className="mt-5 mb-5 d-flex justify-content-center">
                        <ul className="nav nav-pills">
                            ...
                            <li className="nav-item">
                                <Link className="nav-link" to="/concepts/decision-making">Decision making</Link>
                            </li>
                            <li className="nav-item">
                                <Link className="nav-link" to="/concepts/fashion">Fashion</Link>
                            </li>
                            <li className="nav-item">
                                <Link className="nav-link active" to="/concepts/clean-energy">Clean Energy</Link>
                            </li>
                        </ul>
                    </div>
